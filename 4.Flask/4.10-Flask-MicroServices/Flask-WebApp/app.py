...
ai_face_analysis_microservice_url = "http://127.0.0.1:8081/analyze-face"
ai_object_detection_microservice_url = "http://127.0.0.1:8082/detect"
            ...
            if input_image_file.filename == "":
                ...
                if input_image_file and allowed_file(input_image_file.filename):
                    ...
                    response = requests.post(
                        ai_object_detection_microservice_url,
