...
class FaceAnalysis:
    def __init__(self):
        ...
        self.age_gender_model = insightface.model_zoo.get_model('models/genderage.onnx')
    ...
    def detect_age_gender(self, image):
        ...
        for face in faces:
            ...
            cv2.putText(image, label, (bbox[0], bbox[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36, 255, 12), 2)
